...
public class BeetleEntity extends Animal{
	   ...
	   public static boolean canSpawn(EntityType<BeetleEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random) {	   
		   return Animal.checkAnimalSpawnRules(entity, levelAccess, spawnType, pos, random) && pos.getY() > 45 && levelAccess instanceof Level level;
	   }
